    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if(request.getParameter("exportaBD") != null){
            ...
            if(request.getParameter("tipoArchivo").equalsIgnoreCase("excel")){
                ...
                exportarExcel.exportaTablaActosProcesalesJC();
                ...
                exportarExcel.exportaTablaMedidaNoPrivativaJC();
                exportarExcel.exportaTablaMedidaNoPrivativaJO();
