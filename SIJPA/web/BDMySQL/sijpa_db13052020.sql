...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 13-05-2020 a las 19:07:23
...
CREATE TABLE `datos_audiencias_adojo` (
  ...
  `JUZGADO_MUNICIPIO_ID` int(5) NOT NULL,
  `JUZGADO_NUMERO` int(3) NOT NULL,
  `JUZADO_CLAVE` varchar(255) COLLATE utf8_bin NOT NULL,
  `CAUSA_CLAVE` varchar(255) COLLATE utf8_bin NOT NULL,
  `JUEZ_CLAVE1` int(2) NOT NULL,
  `JUEZ_CLAVE2` int(2) NOT NULL,
  `JUEZ_CLAVE3` int(2) NOT NULL,
...
(9, 9007, 125, '199007125', '1-P199007125', 'MANUEL', 'ISLAS', 'PEREZ', 'EL GUAPO', 'SADRHDFRMJUDKIE01E', '1899-09-09', 1, 23, 11, -2, -2, 9, 11, -2, -2, 2, 1, 1, 2, 1, 2, 2, -2, 2, -2, 2, 2, 2, -2, 5, -2, 1, 2, -2, 1, 3, 2, 2, '-2', 2, 4, '', 2020),
(9, 9007, 125, '199007125', '1-P299007125', 'RICARDO', 'LOPEZ', 'SALAS', 'EL CHOLO', 'DOIUSJUOIOEMMDNSJU', '1899-09-09', 2, 26, 3, -2, -2, 12, 12, -2, -2, 4, 2, 1, 2, 2, 2, 2, -2, 2, -2, 2, 2, 2, -2, 4, -2, 1, 2, -2, 3, 1, 3, 2, '-2', 2, 3, '', 2020),
(9, 9007, 125, '299007125', '2-P199007125', 'JORGE', 'MAGAÑA', 'CASTE', 'EL ABUELO', 'JSUYETGSJASKAUIEJJ', '1899-09-09', 1, 27, 8, -2, -2, 6, 10, -2, -2, 2, 2, 1, 2, 2, 2, 2, -2, 2, -2, 2, 1, 2, -2, 5, -2, 2, -2, 1, 3, 3, 3, 2, '-2', 2, 2, '', 2020),
(9, 9007, 125, '299007125', '2-P299007125', 'JORGE ', 'RUEL', 'HERNANDEZ', 'EL CHOPO', 'LSLSLSLSLSLSLSLSLS', '1899-09-09', 1, 27, 8, -2, -2, 11, 3, -2, -2, 3, 2, 2, 2, 2, 2, 9, -2, 2, -2, 1, 2, 2, -2, 4, -2, 2, -2, 1, 3, 2, 1, 2, '-2', 2, 2, '', 2020),
...
(9, 9007, 125, '299007125', '2-P599007125', 'FERNANDO', 'SANCHEZ ', 'VELADOR', 'EL CHOLO', 'SADRHDFRMJUDKIE01E', '1899-09-09', 1, 28, 14, -2, -2, 14, 14, -2, -2, 3, 2, 1, 2, 1, 1, 2, -2, 1, 11, 1, 2, 2, -2, 2, -2, 2, -2, 2, 3, 3, 2, 2, '-2', 2, 3, '', 2020),
(9, 9007, 125, '299007125', '2-P699007125', 'ANABEL', 'PEREZ', 'CRUZ', 'LA REINA', 'DOIUSJUOIOEMMDNSJU', '1899-09-09', 2, 16, 7, -2, -2, 7, 13, -2, -2, 3, 1, 2, 2, 2, 2, 2, -2, 2, -2, 2, 2, 2, -2, 2, -2, 1, 1, -2, 3, 2, 2, 2, '-2', 3, 2, '', 2020),
(9, 9007, 125, '35599007125', '355-P199007125', 'MANUEL', 'ISLAS', 'SALAS', 'EL GUAPO', 'SADRHDFRMJUDKIE01E', '1978-06-06', 1, 21, 1, 4, 4004, 5, 1, 17, 17015, 2, 2, 1, 3, 2, 1, 1, 13, 1, 3, 2, 2, 1, 2, 10, 3, 1, 1, -2, 2, 1, 3, 1, 'la manitas', 1, 2, '', 2020),
(9, 9007, 125, '35599007125', '355-P399007125', 'JORGE', 'MAGAÑA', 'CASTE', 'EL ABUELO', 'jsuyetgsjaskauiejj', '1899-09-09', 2, 29, 17, -2, -2, 13, 14, -2, -2, 6, 2, 2, 4, 9, 1, 2, -2, 2, -2, 2, 2, 2, -2, 5, -2, 1, 2, -2, 5, 2, 2, 2, '-2', 2, 2, '', 2020),
(9, 9007, 125, '35599007125', '355-P599007125', 'FERNANDO', 'SANCHEZ ', 'VELADOR', 'EL CANIJO', 'mais880808hdfwdert', '1899-09-09', 2, 29, 16, -2, -2, 18, 15, -2, -2, 3, 2, 1, 3, 2, 2, 2, -2, 2, -2, 1, 2, 2, -2, 7, -2, 2, -2, 2, 5, 3, 2, 1, 'la manitas', 1, 5, '', 2020);
...
ALTER TABLE `datos_audiencias_adojo`
  ADD PRIMARY KEY (`JUZADO_CLAVE`,`CAUSA_CLAVE`,`JUEZ_CLAVE1`,`JUEZ_CLAVE2`,`JUEZ_CLAVE3`,`AUDIENCIA_JUICIOORAL`) USING BTREE,
  ADD KEY `FK_AUDI_ENTIDADJO` (`JUZGADO_ENTIDAD_ID`),
  ADD KEY `FK_AUDI_MUNICIPIOJO` (`JUZGADO_MUNICIPIO_ID`),
  ADD KEY `FK_AUDI_CAUSACLAVEJO` (`CAUSA_CLAVE`),
  ADD KEY `FK_AUDI_JUEZ1JO` (`JUZADO_CLAVE`,`JUEZ_CLAVE1`),
  ADD KEY `FK_AUDI_JUEZ2JO` (`JUZADO_CLAVE`,`JUEZ_CLAVE2`),
  ADD KEY `FK_AUDI_JUEZ3JO` (`JUZADO_CLAVE`,`JUEZ_CLAVE3`),
...
ALTER TABLE `datos_delitos_adojo`
  ADD PRIMARY KEY (`CAUSA_CLAVEJO`,`DELITO_CLAVE`),
...
ALTER TABLE `datos_victimas_adojo`
  ADD PRIMARY KEY (`CAUSA_CLAVEJO`,`VICTIMA_CLAVE`),
...
--
ALTER TABLE `datos_audiencias_adojo`
  ADD CONSTRAINT `FK_AUDI_CAUSACLAVEJO` FOREIGN KEY (`CAUSA_CLAVE`) REFERENCES `datos_causas_penales_adojo` (`CAUSA_CLAVEJO`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_AUDI_ENTIDADJO` FOREIGN KEY (`JUZGADO_ENTIDAD_ID`) REFERENCES `catalogos_entidades` (`ENTIDAD_ID`),
  ADD CONSTRAINT `FK_AUDI_JUEZ1JO` FOREIGN KEY (`JUZADO_CLAVE`,`JUEZ_CLAVE1`) REFERENCES `datos_jueces_adojc` (`JUZGADO_CLAVE`, `JUEZ_CLAVE`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_AUDI_JUEZ2JO` FOREIGN KEY (`JUZADO_CLAVE`,`JUEZ_CLAVE2`) REFERENCES `datos_jueces_adojc` (`JUZGADO_CLAVE`, `JUEZ_CLAVE`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_AUDI_JUEZ3JO` FOREIGN KEY (`JUZADO_CLAVE`,`JUEZ_CLAVE3`) REFERENCES `datos_jueces_adojc` (`JUZGADO_CLAVE`, `JUEZ_CLAVE`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `FK_AUDI_JUZGADOCLAVEJO` FOREIGN KEY (`JUZADO_CLAVE`) REFERENCES `datos_juzgados_adojc` (`JUZGADO_CLAVE`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `datos_conclusiones_adojo`
  ...
  ADD CONSTRAINT `FK_CONCLU_PROCESACLAVEJO` FOREIGN KEY (`CAUSA_CLAVEJO`,`PROCESADO_CLAVE`) REFERENCES `datos_procesados_adojo` (`CAUSA_CLAVEJO`, `PROCESADO_CLAVE`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `datos_dconclusiones_adojo`
  ...
  ADD CONSTRAINT `FK_DCON_DELITOCLAVEJO` FOREIGN KEY (`CAUSA_CLAVEJO`,`DELITO_CLAVE`) REFERENCES `datos_delitos_adojo` (`CAUSA_CLAVEJO`, `DELITO_CLAVE`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `FK_DCON_PROCESACLAVEJO` FOREIGN KEY (`CAUSA_CLAVEJO`,`PROCESADO_CLAVE`) REFERENCES `datos_procesados_adojo` (`CAUSA_CLAVEJO`, `PROCESADO_CLAVE`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `datos_dhomicidio_adojo`
  ...
  ADD CONSTRAINT `FK_DHOMI_DELITOCLAVE` FOREIGN KEY (`CAUSA_CLAVEJO`,`DELITO_CLAVE`) REFERENCES `datos_delitos_adojo` (`CAUSA_CLAVEJO`, `DELITO_CLAVE`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `datos_drobo_adojo`
  ...
  ADD CONSTRAINT `FK_DROBO_DELITOCLAVEJO` FOREIGN KEY (`CAUSA_CLAVEJO`,`DELITO_CLAVE`) REFERENCES `datos_delitos_adojo` (`CAUSA_CLAVEJO`, `DELITO_CLAVE`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `datos_etapa_oral_adojo`
  ...
  ADD CONSTRAINT `FK_EORAL_PROCESACLAVEJO` FOREIGN KEY (`CAUSA_CLAVEJO`,`PROCESADO_CLAVE`) REFERENCES `datos_procesados_adojo` (`CAUSA_CLAVEJO`, `PROCESADO_CLAVE`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `datos_pdelitos_adojo`
  ...
  ADD CONSTRAINT `FK_PDELI_DELITOCLAVEJO` FOREIGN KEY (`CAUSA_CLAVEJO`,`DELITO_CLAVE`) REFERENCES `datos_delitos_adojo` (`CAUSA_CLAVEJO`, `DELITO_CLAVE`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `FK_PDELI_PROCESADOCLAVEJO` FOREIGN KEY (`CAUSA_CLAVEJO`,`PROCESADO_CLAVE`) REFERENCES `datos_procesados_adojo` (`CAUSA_CLAVEJO`, `PROCESADO_CLAVE`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `datos_pfuente_ingresos_adojo`
  ...
  ADD CONSTRAINT `FK_PFUENT_PROCECLAVEJO` FOREIGN KEY (`CAUSA_CLAVEJO`,`PROCESADO_CLAVE`) REFERENCES `datos_procesados_adojo` (`CAUSA_CLAVEJO`, `PROCESADO_CLAVE`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `datos_tramites_adojo`
  ...
  ADD CONSTRAINT `FK_TRAM_PROCESACLAVEJO` FOREIGN KEY (`CAUSA_CLAVEJO`,`PROCESADO_CLAVE`) REFERENCES `datos_procesados_adojo` (`CAUSA_CLAVEJO`, `PROCESADO_CLAVE`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `datos_vdelitos_adojo`
  ...
  ADD CONSTRAINT `FK_VDELI_DELITOCLAVEJO` FOREIGN KEY (`CAUSA_CLAVEJO`,`DELITO_CLAVE`) REFERENCES `datos_delitos_adojo` (`CAUSA_CLAVEJO`, `DELITO_CLAVE`) ON DELETE CASCADE ON UPDATE CASCADE,
  ...
  ADD CONSTRAINT `FK_VDELI_VICTIMACLAVEJO` FOREIGN KEY (`CAUSA_CLAVEJO`,`VICTIMA_CLAVE`) REFERENCES `datos_victimas_adojo` (`CAUSA_CLAVEJO`, `VICTIMA_CLAVE`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `datos_vfuente_ingresos_adojo`
  ...
  ADD CONSTRAINT `FK_VFUENT_VICTIMACLAVE` FOREIGN KEY (`CAUSA_CLAVEJO`,`VICTIMA_CLAVE`) REFERENCES `datos_victimas_adojo` (`CAUSA_CLAVEJO`, `VICTIMA_CLAVE`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `datos_vprocesados_adojo`
  ...
  ADD CONSTRAINT `FK_VPRO_PROCESCLAVEJO` FOREIGN KEY (`CAUSA_CLAVEJO`,`PROCESADO_CLAVE`) REFERENCES `datos_procesados_adojo` (`CAUSA_CLAVEJO`, `PROCESADO_CLAVE`) ON DELETE CASCADE ON UPDATE CASCADE,
  ADD CONSTRAINT `FK_VPRO_RELACIONJO` FOREIGN KEY (`RELACION`) REFERENCES `catalogos_relacion_imputado` (`RELACION_ID`),
  ADD CONSTRAINT `FK_VPRO_VICTIMACLAVEJO` FOREIGN KEY (`CAUSA_CLAVEJO`,`VICTIMA_CLAVE`) REFERENCES `datos_victimas_adojo` (`CAUSA_CLAVEJO`, `VICTIMA_CLAVE`) ON DELETE CASCADE ON UPDATE CASCADE;
