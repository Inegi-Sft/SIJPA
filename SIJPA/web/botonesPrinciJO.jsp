...
<%
    if(request.getParameter("causaClaveJO") != null){
        ...
        String [] pestanas = {"Causa Penal","Delitos","Imputados","Víctimas","Juicio Oral",
...
%>
    ...
    <button class="pestanaLinks" onclick="openPestana('btn7', 'p7')" id="btn7" disabled>Trámite</button>
