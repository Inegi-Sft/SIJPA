...
%>
    ...
    <button class="pestanaLinks" onclick="openPestana('btn5', 'p5')" id="btn5">Juicio Oral</button>
    <button class="pestanaLinks" onclick="openPestana('btn6', 'p6')" id="btn6">Conclusion</button>
    <button class="pestanaLinks" onclick="openPestana('btn7', 'p7')" id="btn7">Tramite</button>
