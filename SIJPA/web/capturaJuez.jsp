                    ...
                    <table  class="tablaFormu">
                        ...
                        <tr>
                            <td>
                                ...
                                <input type="text" onkeypress="return /[[A-Z Ñ]|[Á,É,Í,Ó,Ú,Ä,Ë,Ï,Ö,Ü]/i.test(event.key)" name="nombre" id="nombre" value="<%=nombreJuez%>" required/>
                            </td>
                            <td>
                                <label for="apaterno">Apellido Paterno</label>
                                <input type="text" onkeypress="return /[[A-Z Ñ]|[Á,É,Í,Ó,Ú,Ä,Ë,Ï,Ö,Ü]/i.test(event.key)" name="apaterno" id="apaterno" value="<%=apePateJuez%>" required/>
                            </td>
                            <td>
                                <label for="amaterno">Apellido Materno</label>
                                <input type="text" onkeypress="return /[[A-Z Ñ]|[Á,É,Í,Ó,Ú,Ä,Ë,Ï,Ö,Ü]/i.test(event.key)" name="amaterno" id="amaterno" value="<%=apeMateJuez%>" required/>
                            </td>
                            <td>
