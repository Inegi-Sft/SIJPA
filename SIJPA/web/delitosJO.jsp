...
<html>
    <head>
        ...
        <script type="text/javascript" src="js/funcionesDelJO.js?v=<%=(int)(Math.random()*10+1)%>"></script>
        <%
                        ...
                        <tr>
                            ...
                            <td colspan="2">
                                <fieldset>
                                    ...
                                    <div class="cols lblExBig">
                                        <label class="lblExBig">Municipio (Para CDMX Demarcación Territorial)</label>
