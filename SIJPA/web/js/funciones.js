        ...
        $.ajax({
            ...
            success: function (response) {
                ...
                if (response === 1) {
                    ...
                    alert('Usuario no encontrado, favor de revisar usuario o contraseÒa');
                }
            },
    ...
    $('#confPass').keyup(function(){
        if($('#confPass').val() !== ''){
            if ($('#confPass').val() === $('#pass').val()) {
                $('#mesajePass').text('Las contraseÒas son correctas');
                $('#mesajePass').css({'color':'#66cc00'});
                $('#guardar').fadeIn('slow');
            }else{
                $('#mesajePass').text('Las contraseÒas no coinciden');
